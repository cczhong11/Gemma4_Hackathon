...
///
/// NOTE: Slimmed to Gemma family only for Gemma4Runtime. Upstream mlx-swift-lm registers ~50
/// model types (Llama, Phi, Qwen, Mistral, DeepSeek, ...). Gemma4Runtime ships Gemma 4 exclusively
...
///
/// NOTE: Slimmed to Gemma family only for Gemma4Runtime. See the comment on LLMTypeRegistry
/// above — Gemma4Runtime registers its own Gemma 4 model type at runtime, and no other
