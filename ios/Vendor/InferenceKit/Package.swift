...
//
// NOTE: This is a SLIMMED fork of upstream `mlx-swift-lm` for Gemma4Runtime.
// Gemma4Runtime only uses text LLM + multimodal VLM via a custom Gemma 4 implementation,
