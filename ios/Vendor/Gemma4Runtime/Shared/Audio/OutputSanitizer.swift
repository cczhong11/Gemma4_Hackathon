...
private let thinkingOpenMarker = "[[GEMMA4RUNTIME_THINK]]"
private let thinkingCloseMarker = "[[/GEMMA4RUNTIME_THINK]]"

enum OutputSanitizer {

    enum Mode {
        case chatUI      // thinking channel → [[GEMMA4RUNTIME_THINK]]...
    ...
    static func sanitize(_ buffer: String, mode: Mode) -> (safe: String, pending: String) {
        ...
        if mode == .liveVoice {
            ...
            // chatUI: strip tags but preserve [[GEMMA4RUNTIME_THINK]] markers
    ...
    /// Chat UI: convert <|channel|>thought\n...<channel|> to [[GEMMA4RUNTIME_THINK]]...[[/GEMMA4RUNTIME_THINK]]
    ...
    /// Strip ML tags but preserve [[GEMMA4RUNTIME_THINK]] markers
